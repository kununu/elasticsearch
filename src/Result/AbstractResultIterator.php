...
abstract class AbstractResultIterator implements Iterator, ArrayAccess, Countable, ResultIteratorInterface
{
    ...
    public function setScrollId(?string $scrollId): static
    {
    ...
    public function push(array|object $result): static
    {
        $this->results[] = $result;
